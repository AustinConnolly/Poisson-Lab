...
def poissondis(x):
    return (((10.27)**x)/gamma(x+1))*np.exp(-10.27)

xx=np.linspace(7.75,13.55,100)
...
#step=A*histdata1[1]-A*histdata1[0]
#yUpper=[(1-stats.poisson.cdf(A*histdata1[-2], meanCount))*N]*2
#yLower=[(stats.poisson.cdf(A*histdata1[1], meanCount))*N]*2
#plt.plot([A*histdata1[-2], A*histdata1[-2]+step], yUpper,color='r')
#plt.plot([A*histdata1[1]-step, A*histdata1[1]], yLower,color='r')
...
#cntrhistbin=[6.85,8.75,10.65,12.55,14.45]
